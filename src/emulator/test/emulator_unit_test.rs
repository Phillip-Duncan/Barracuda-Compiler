...
fn test_instruction_values_padding() {
    ...
    let padded_values = emulator::ThreadContext::pad_list_to_size_of_instructions(VALUE, &instructions, &unpadded_values, 0.0);
...
fn test_instruction_operations_padding() {
    ...
    let padded_operations = emulator::ThreadContext::pad_list_to_size_of_instructions(OP, &instructions, &unpadded_operations, NULL);
